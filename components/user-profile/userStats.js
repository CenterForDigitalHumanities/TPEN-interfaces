...
class UserStats extends HTMLElement {
    ...
    connectedCallback() {
        TPEN.eventDispatcher.on('tpen-user-loaded', async ev => {
            this.render(ev.detail, await TPEN.getUserProjects(TPEN.getAuthorization()))
    ...
    render(profile,projects) {
        ...
        const collaborators = [
            { name: Array.from(uniqueCollaborators)[0], img: 'https://www.gravatar.com/avatar/11111111111111111111111111111111?s=100&d=identicon' },
            { name: Array.from(uniqueCollaborators)[1], img: 'https://www.gravatar.com/avatar/22222222222222222222222222222222?s=100&d=identicon' },
        ]
