  ...
  */
  ...
  setInitialAnnotations() {
    ...
    allAnnotations.map(annotation => {
      ...
      // FIXME because this is presuming inbound Annotations have simplified FragmentSelector format.
      // Annotations generated by this interfaced are saved out with this simplified format.
  ...
  convertSelectors(annotations, bool = false) {
    ...
    return annotations.map(annotation => {
      ...
      if (bool) {
         ...
         * FIXME this presumes the Annotations have a target in simplified uri#xywh= format.
         * Annotations generated by this interfaced are saved out with this simplified format.
         */
  ...
  roundSelectors(annotations) {
    ...
    return annotations.map(annotation => {
      if (!annotation.target) return annotation
        // The target is in simplified uri#xywh= format
        const tar = annotation.target.split("#")[0]
        const sel = annotation.target.split("#")[1]
        let orig_xywh, rounded_xywh = []
        orig_xywh = sel.replace("xywh=", "").split(",")
        ...
        annotation.target = tar + "#xywh=" + rounded_xywh.join(",")
      return annotation
    })
  }
  ...
  cleanAnnotations(annotations) {
    ...
    return annotations.map(annotation => {
      ...
      delete annotations.body.created
      delete annotations.body.creator
      delete annotations.body.modified
      delete annotations.body.purpose
  ...
  async saveAnnotations() {
    ...
    // Remove undefined and nulls generated by Annotorious
